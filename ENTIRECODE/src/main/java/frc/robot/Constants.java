...
// Swerve Constants
  public static final class SwerveConstants{
    ...
    public static ModuleData[] moduleData = { 
      new ModuleData(4, 2, 3, 97.11, FRONT_LEFT), //Mod 0
      new ModuleData(7, 5, 6, 268.51, FRONT_RIGHT), //Mod 1
      new ModuleData(10, 8, 9, 31.72, BACK_RIGHT), //Mod 2
      new ModuleData(13, 11, 12, 345.06, BACK_LEFT) //Mod 3
    };
