...
public class OneCoralAuto extends SequentialCommandGroup{
    public OneCoralAuto (SwerveSubsystem drive, ElevatorSubsystem elevator, WristSubsystem wrist, IntakeSubsystem intake) {
        addCommands(
