...
public class AutoAlign extends Command {
    ...
    private PIDController xController = new PIDController(0.8, 0, 0); // PID driving field X toward target
    private PIDController yController = new PIDController(0.8, 0, 0); // PID driving field Y toward target
    private PIDController rotationController = new PIDController(0.005, 0, 0); // PID steering heading toward goal
    private boolean isLeft; // True when aligning to left branch instead of right
